# unified_astro_logger_v4.py (v17)
#
# Changelog:
...
class ImageFileHandler(FileSystemEventHandler):
    ...
    def calibrate_image(self, image_path, dark_path, flat_path):
        try:
            ...
            if is_roi:
                # Assume centered ROI, calculate crop offsets
                ...
                # Crop master frames to match ROI, assuming centered
            ...
            if is_roi:
                image_header.add_history(f"Calibrated as ROI: Cropped dark by ({x_offset_dark}, {y_offset_dark}), flat by ({x_offset_flat}, {y_offset_flat})")
            if num_saturated > 0:
